...
// main function serves as the application's entry point. It initializes the SIGIL Editor application,
// creates the main window, and runs the application. It logs any error that might occur during execution.
func main() {
